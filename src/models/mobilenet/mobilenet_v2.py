...
def MobileNetV2_(num_classes=1000, pretrained: bool = True, progress: bool = True, **kwargs) -> MobileNetV2:
    """
    ...
    model.classifier = nn.Sequential(nn.Dropout(p=0.2, inplace=False), nn.Linear(1280, num_classes))
