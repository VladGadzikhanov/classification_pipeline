...
def densenet121(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    model = _densenet("densenet121", 32, (6, 12, 24, 16), 64, pretrained, progress, **kwargs)
