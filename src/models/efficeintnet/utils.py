"""general.py - Helper functions for building the model and for loading model parameters.
...
def load_pretrained_weights(model, model_name, weights_path=None, load_fc=True, advprop=False, verbose=True):
    ...
    if load_fc:
        ...
        #     ['fc.weight', 'fc.bias', 'attn.weight', 'attn.bias', '_fc.weight', '_fc.bias']), 'Missing keys when loading pretrained weights: {}'.format(ret.missing_keys)
